...
const FirmCollections = () => {
    ...
    const firmDataHandler = async () => {
        try {
            ...
            alert("Failed to fetch firmData");
            console.error("Failed to fetch firmData", error);
    ...
    return (
        <>
            <h3>Restaurant with online food delivery in Hyderabad</h3>
                                ...
                                <Link to={`/products/${item._id}/${item.firmName}`} className="link" key={item._id} >
                                    <div className="zoomEffect">
                                        ...
                                        <div className='firmGroup'>
                                            <img src={`${API_URL}/uploads/${item.image}`} alt={item._id} />
